 ...
 *
 * Reads entries from the local storage backend and writes them to the AWS cloud via
...
export interface MigrationOptions {
  /** Authenticated user's Cognito ID */
  userId: string;
  /** Local storage backend (guest data source) */
  storage: StorageBackend;
  /** Cloud bridge for writing to AWS */
 ...
 *
 * Scans the storage backend for guest data entries, writes each to the AWS cloud
